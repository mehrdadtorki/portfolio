    ...
    >
      <div className="h-full w-full flex flex-col gap-5 justify-center m-auto text-start">
        ...
        <motion.div
          ...
          className="flex flex-col gap-6 mt-6 text-5xl font-semibold text-white max-w-[600px] w-auto h-auto"
        >
          <span>
            i am
            <br />
        ...
        >
          I&apos;m a Full Stack Software Developer with experience in Mobile,
